...
public class MenuPanel {
	...
	int difficultyLevel;
	public static JFrame staticFrame;
		...
		easyButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (random == 0) {
							...
							singlePlayer.keypress=0;
						}else {
							background.setText("Team CPU Won");
							singlePlayer.keypress=1;
						}
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (isSinglePlayer) {
					...
					if (difficultyLevel == 1) {
						...
						singlePlayer.gameMain(2);
					}
					staticFrame = singlePlayer.getFrame();
				}else {
					multiplayer.gameMain();
					staticFrame = multiplayer.getFrame();
